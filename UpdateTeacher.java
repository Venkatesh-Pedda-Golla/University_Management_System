...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        cemployeeid.setBounds(250, 100, 200, 20);
        add(cemployeeid);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelrollno.setText(rs.getString("employeeid"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"' where employeeid='"+empid+"'";
                Conn con = new Conn();
